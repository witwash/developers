...
class _$LanguageTearOff {
  ...
  _Language call(
      {@JsonKey(name: 'iso_639_1') required String iso, required String name}) {
    return _Language(
      iso: iso,
      name: name,
    );
...
abstract class $LanguageCopyWith<$Res> {
  ...
  $Res call({@JsonKey(name: 'iso_639_1') String iso, String name});
}
...
class _$_Language implements _Language {
  const _$_Language(
      {@JsonKey(name: 'iso_639_1') required this.iso, required this.name});
  ...
  @override
  String toString() {
    return 'Language(iso: $iso, name: $name)';
  }
...
abstract class _Language implements Language {
  const factory _Language(
      ...
      required String name}) = _$_Language;
