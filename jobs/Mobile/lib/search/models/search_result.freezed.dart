...
abstract class $SearchResultCopyWith<$Res> {
  ...
  $Res call({List<MoviePreview> previews, int totalPages, int totalResult});
}
...
class _$_SearchResult implements _SearchResult {
  ...
  @override
  String toString() {
    return 'SearchResult(previews: $previews, totalPages: $totalPages, totalResult: $totalResult)';
  }
...
abstract class _SearchResult implements SearchResult {
  const factory _SearchResult(
      {required List<MoviePreview> previews,
      required int totalPages,
      required int totalResult}) = _$_SearchResult;
